...
/**
 * The traineddata bundled in the SDK jar under {@code tessdata/} — the closed set of languages {@link Text}
 * can actually recognise without the user installing anything.
 *
